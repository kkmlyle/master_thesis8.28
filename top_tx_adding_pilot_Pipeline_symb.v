...
wire   [0:0] tmp_s_nbreadreq_fu_64_p3;
...
wire   [63:0] zext_ln64_fu_184_p1;
wire   [0:0] icmp_ln58_fu_173_p2;
wire   [63:0] i_cast5_fu_165_p1;
reg   [10:0] i_fu_52;
wire   [10:0] add_ln54_fu_154_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_9;
wire   [9:0] empty_56_fu_170_p1;
wire   [9:0] add_ln64_fu_178_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln54_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_52 <= add_ln54_fu_154_p2;
...
always @ (*) begin
    if (((icmp_ln54_fu_148_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_s_nbreadreq_fu_64_p3 == 1'd1) & (tmp_nbreadreq_fu_56_p3 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln58_fu_173_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_s_nbreadreq_fu_64_p3 == 1'd1) & (tmp_nbreadreq_fu_56_p3 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln58_fu_173_p2 == 1'd0))) begin
...
assign add_ln54_fu_154_p2 = (ap_sig_allocacmp_i_9 + 11'd1);

assign add_ln64_fu_178_p2 = (empty_56_fu_170_p1 + 10'd424);
...
always @ (*) begin
    ap_predicate_op26_read_state2 = ((tmp_s_nbreadreq_fu_64_p3 == 1'd1) & (tmp_nbreadreq_fu_56_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op27_read_state2 = ((tmp_s_nbreadreq_fu_64_p3 == 1'd1) & (tmp_nbreadreq_fu_56_p3 == 1'd1));
end

assign empty_56_fu_170_p1 = i_9_reg_197[9:0];

assign i_cast5_fu_165_p1 = i_9_reg_197;

assign icmp_ln54_fu_148_p2 = ((ap_sig_allocacmp_i_9 == 11'd1200) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_173_p2 = ((i_9_reg_197 < 11'd600) ? 1'b1 : 1'b0);

assign symb1_M_imag_V_address0 = i_cast5_fu_165_p1;

assign symb1_M_imag_V_d0 = temp1_im398_dout;

assign symb1_M_real_V_address0 = i_cast5_fu_165_p1;

assign symb1_M_real_V_d0 = temp1_re397_dout;

assign symb2_M_imag_V_address0 = zext_ln64_fu_184_p1;

assign symb2_M_imag_V_d0 = temp1_im398_dout;

assign symb2_M_real_V_address0 = zext_ln64_fu_184_p1;

assign symb2_M_real_V_d0 = temp1_re397_dout;

assign tmp_nbreadreq_fu_56_p3 = temp1_re397_empty_n;

assign tmp_s_nbreadreq_fu_64_p3 = temp1_im398_empty_n;

assign zext_ln64_fu_184_p1 = add_ln64_fu_178_p2;

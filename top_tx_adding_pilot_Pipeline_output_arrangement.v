...
wire   [0:0] icmp_ln113_fu_168_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [9:0] pilot_sym_M_real_address0;
reg    pilot_sym_M_real_ce0;
wire   [14:0] pilot_sym_M_real_q0;
wire   [9:0] pilot_sym_M_imag_address0;
reg    pilot_sym_M_imag_ce0;
wire   [14:0] pilot_sym_M_imag_q0;
reg    temp2_re399_blk_n;
wire    ap_block_pp0_stage0;
reg    temp2_im400_blk_n;
wire   [0:0] icmp_ln115_fu_200_p2;
reg    ap_block_pp0_stage0_11001;
wire   [63:0] zext_ln122_fu_214_p1;
wire   [63:0] i_10_cast8_fu_180_p1;
reg   [11:0] i_fu_60;
wire   [11:0] add_ln113_fu_174_p2;
wire    ap_loop_init;
reg   [11:0] ap_sig_allocacmp_i_10;
reg    ap_block_pp0_stage0_01001;
wire  signed [15:0] sext_ln117_fu_227_p1;
wire  signed [15:0] sext_ln118_fu_232_p1;
wire   [1:0] tmp_fu_190_p4;
wire   [9:0] empty_57_fu_186_p1;
reg    ap_done_reg;
...
top_tx_adding_pilot_Pipeline_output_arrangement_pilot_sym_M_real_ROM_AUTO_1R #(
    .DataWidth( 15 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
pilot_sym_M_real_U(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln113_fu_168_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_60 <= add_ln113_fu_174_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln113_fu_168_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln115_reg_247 <= icmp_ln115_fu_200_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln113_fu_168_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln115_fu_200_p2 == 1'd0))) begin
        tmp_17_reg_251 <= ap_sig_allocacmp_i_10[32'd11];
    end
end

always @ (*) begin
    if (((icmp_ln113_fu_168_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_194)) begin
        if ((icmp_ln115_reg_247 == 1'd1)) begin
            temp2_im400_din = sext_ln118_fu_232_p1;
...
always @ (*) begin
    if ((1'b1 == ap_condition_194)) begin
        if ((icmp_ln115_reg_247 == 1'd1)) begin
            temp2_re399_din = sext_ln117_fu_227_p1;
...
assign add_ln113_fu_174_p2 = (ap_sig_allocacmp_i_10 + 12'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln115_reg_247 == 1'd1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op48_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op43_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((temp2_im400_full_n == 1'b0) & (icmp_ln115_reg_247 == 1'd1)) | ((ap_predicate_op41_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln115_reg_247 == 1'd1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op48_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op43_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((temp2_im400_full_n == 1'b0) & (icmp_ln115_reg_247 == 1'd1)) | ((ap_predicate_op41_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((icmp_ln115_reg_247 == 1'd1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op48_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0)) | ((ap_predicate_op43_write_state2 == 1'b1) & (temp2_im400_full_n == 1'b0)) | ((temp2_im400_full_n == 1'b0) & (icmp_ln115_reg_247 == 1'd1)) | ((ap_predicate_op41_write_state2 == 1'b1) & (temp2_re399_full_n == 1'b0)));
end

always @ (*) begin
    ap_condition_194 = ((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
always @ (*) begin
    ap_predicate_op41_write_state2 = ((tmp_17_reg_251 == 1'd0) & (icmp_ln115_reg_247 == 1'd0));
end

always @ (*) begin
    ap_predicate_op43_write_state2 = ((tmp_17_reg_251 == 1'd0) & (icmp_ln115_reg_247 == 1'd0));
end

always @ (*) begin
    ap_predicate_op46_write_state2 = ((tmp_17_reg_251 == 1'd1) & (icmp_ln115_reg_247 == 1'd0));
end

always @ (*) begin
    ap_predicate_op48_write_state2 = ((tmp_17_reg_251 == 1'd1) & (icmp_ln115_reg_247 == 1'd0));
end

assign data_symb1_M_imag_V_address0 = zext_ln122_fu_214_p1;

assign data_symb1_M_real_V_address0 = zext_ln122_fu_214_p1;

assign data_symb2_M_imag_V_address0 = zext_ln122_fu_214_p1;

assign data_symb2_M_real_V_address0 = zext_ln122_fu_214_p1;

assign empty_57_fu_186_p1 = ap_sig_allocacmp_i_10[9:0];

assign i_10_cast8_fu_180_p1 = ap_sig_allocacmp_i_10;

assign icmp_ln113_fu_168_p2 = ((ap_sig_allocacmp_i_10 == 12'd3072) ? 1'b1 : 1'b0);

assign icmp_ln115_fu_200_p2 = ((tmp_fu_190_p4 == 2'd0) ? 1'b1 : 1'b0);

assign pilot_sym_M_imag_address0 = i_10_cast8_fu_180_p1;

assign pilot_sym_M_real_address0 = i_10_cast8_fu_180_p1;

assign sext_ln117_fu_227_p1 = $signed(pilot_sym_M_real_q0);

assign sext_ln118_fu_232_p1 = $signed(pilot_sym_M_imag_q0);

assign tmp_fu_190_p4 = {{ap_sig_allocacmp_i_10[11:10]}};

assign zext_ln122_fu_214_p1 = empty_57_fu_186_p1;
